...
$(document).ready(function () {
    ...
    function initialize() {
        ...
        var place0 = new google.maps.LatLng(53.95273, -97.08115);
        var place1 = new google.maps.LatLng(43.95473, -95.08215);
        var place2 = new google.maps.LatLng(39.95573, -98.08315);
        var place3 = new google.maps.LatLng(33.95773, -98.08415);
        var place4 = new google.maps.LatLng(38.95173, -87.08515);
        var place5 = new google.maps.LatLng(43.95273, -88.08615);

        // place markers
        fnPlaceMarkers(place0, "RV Motor Coach", 'assets/media/camp/map-pin.png');
        fnPlaceMarkers(place1, "RV Motor Coach", 'assets/media/camp/map-pin.png');
        fnPlaceMarkers(place2, "RV Motor Coach", 'assets/media/camp/map-pin.png');
        fnPlaceMarkers(place3, "RV Motor Coach", 'assets/media/camp/map-pin.png');
        fnPlaceMarkers(place4, "RV Motor Coach", 'assets/media/camp/map-pin.png');
        fnPlaceMarkers(place5, "RV Motor Coach", 'assets/media/camp/map-pin.png');
