                                                                ...
                                                                <div class="js-slider vh-slider"
                                                                    ...
                                                                    <div class="b-goods-f ">
                                                                        <div class="b-goods-f__media"><img
                                                                                class="b-goods-f__img img-scale img-custom-carousel"
                                        ...
                                        <ul class="b-steps-list list-unstyled">
                                            <li class="row">
                                                ...
                                                <div class="col">
                                                    ...
                                                    <div class="b-steps-list__info text-justify">Kami selalu menjaga
                                                        performa serta
                                                        kebersihan dari mobil yang kami tawarkan dengan melakukan
                                                        service secara
                                                        berkala</div>
                                                </div>
                                            </li>
                                            <li class="row">
                                                ...
                                                <div class="col">
                                                    ...
                                                    <div class="b-steps-list__info text-justify">Driver yang kami miliki
                                                        tentunya
                                                        memiliki
                                                        pegalaman dibidangnya, serta mengutamakan sikap ramah terhadap
                                                        customer
                                                    </div>
                                                </div>
                                            </li>
                                            <li class="row">
                                                ...
                                                <div class="col">
                                                    ...
                                                    <div class="b-steps-list__info text-justify">Harga untuk sewa mobil
                                                        dan paket
                                                        wisata yang
                                                        kami tawarkan sangat terjangkau sesuai dengan fasilitas yang
                                                        memuaskan
                                                    </div>
                                                </div>
                                            </li>
                                            <li class="row">
                                                ...
                                                <div class="col">
                                                    ...
                                                    <div class="b-steps-list__info text-justify">Kami sangat menghargai
                                                        waktu Anda,
                                                        maka dari
                                            ...
                                            <li class="row">
                                                ...
                                                <div class="col">
                                                    ...
                                                    <div class="b-steps-list__info text-justify">Anda bisa melakukan
                                                        pemesanan
                                                        dengan mudah
                                                        melalui website dan sosial media kami. Atau bisa langsung
                                                        menghubungi
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-4 col-lg-4">
                                        <div class="fbox fbox-even">
                                            ...
                                            <div class="img-box">
                                                <img class="w-100 img-custom-sewa"
                                                    src="{{ asset('media/image/inova-reborn.png') }}" alt="">
                                            </div>
                                            <h4>Inova Reborn</h4>
                                            <div class="fbox_info text-left">
                                                <p class="mb-5px"><i class="fa-solid fa-check mr-2"></i>Include Mobil
                                                    & Driver</p>
                                                ...
                                                <p class="mb-5px"><i
                                                        ...
                                                        Service</strong></p>
                                                <p class="mb-5px"><i class="fa-solid fa-xmark mr-2"></i>Tidak termasuk
                                                    BBM</p>
                                                <p class="mb-5px"><i class="fa-solid fa-xmark mr-2"></i>Tidak termasuk
                                                    Tol &
                                                    Parkir</p>
                                    ...
                                    <div class="col-sm-12 col-md-4 col-lg-4">
                                        <div class="fbox fbox-even">
                                            ...
                                            <div class="img-box">
                                                <img class="w-100 img-custom-sewa"
                                                    src="{{ asset('media/image/hiace.png') }}" alt="">
                                            </div>
                                            <h4>Toyota Hiace</h4>
                                            <div class="fbox_info text-left">
                                                <p class="mb-5px"><i class="fa-solid fa-check mr-2"></i>Include Mobil
                                    ...
                                    <div class="col-sm-12 col-md-4 col-lg-4">
                                        <div class="fbox fbox-even">
                                            ...
                                            <div class="img-box">
                                                <img class="w-100 img-custom-sewa"
                                                    src="{{ asset('media/image/elf-long.png') }}" alt="">
                                            </div>
                                            <h4>Elf Long</h4>
                                            <div class="fbox_info text-left">
                                                <p class="mb-5px"><i class="fa-solid fa-check mr-2"></i>Include Mobil
                                    ...
                                    <div class="col-sm-12 col-md-4 col-lg-4">
                                        <div class="fbox fbox-even">
                                            ...
                                            <div class="img-box">
                                                <img class="w-100 img-custom-sewa"
                                                    src="{{ asset('media/image/avanza.png') }}" alt="">
                                            </div>
                                            <h4>Mobilio</h4>
                                            <div class="fbox_info text-left">
                                                <p class="mb-5px"><i class="fa-solid fa-check mr-2"></i>Include Mobil
                                                            ...
                                                            <li class="gallery__item row-2">
                                                                <div class="b-reviews-slider-2 js-slider">
                                                                    <div class="b-reviews-2">
                                                                        <blockquote class="b-reviews-2__blockquote">
                                                                            <div class="b-reviews-2__wrap">
                                                                                <p>Pelayanan sangat bagus, driver santun
                                                                                    dan ramah,
                                                                                    mobil sangat nyaman</p>
                                                                            </div>
                                                                            <div class="b-reviews-2__cite"
                                                                                title="Blockquote Title">
                                                                                <span class="b-reviews-2__name">Farhan
                                                                                    Halim -
                                                                                    Malang</span>
                                                                    ...
                                                                    <div class="b-reviews-2">
                                                                        <blockquote class="b-reviews-2__blockquote">
                                                                            <div class="b-reviews-2__wrap">
                                                                                <p>Kendaraan sesuai pesanan, baik,
                                                                                    nyaman, bersih,
                                                                                    penjemputan tepat waktu Driver
                                                                                    profesional,
                                                                                    melayani dengan baik pokoknya
                                                                                    memuaskan deh </p>
                                                                            </div>
                                                                            <div class="b-reviews-2__cite"
                                                                                title="Blockquote Title">
                                                                                <span class="b-reviews-2__name">Tina
                                                                                    Sumiati -
                                                                                    Dau</span>
                                                                                <div class="slider-review-stars">
                                                                                    <i class="fa-solid fa-star"></i>
                                                                    ...
                                                                    <div class="b-reviews-2">
                                                                        <blockquote class="b-reviews-2__blockquote">
                                                                            <div class="b-reviews-2__wrap">
                                                                                <p>Respon operator cepat, mobil bagus,
                                                                                    bersih,
                                                                                    terawat, drivernya baik banget,
                                                                                    pengalaman,
                                                                                    nyetir sopan dan safety. Recommended
                                                                                    buat
                                                                                    sewa lagi dan tingkatkan terus
                                                                                    pelayanannya
                                                                                    ya...
                                                                            ...
                                                                            <div class="b-reviews-2__cite"
                                                                                title="Blockquote Title">
                                                                                <span class="b-reviews-2__name">Dimas
                                                                                    Suhendro -
                                                                                    Wagir</span>
                                                                                <div class="slider-review-stars">
                                                                                    <i class="fa-solid fa-star"></i>
                                                                    ...
                                                                    <div class="b-reviews-2">
                                                                        <blockquote class="b-reviews-2__blockquote">
                                                                            <div class="b-reviews-2__wrap">
                                                                                <p>rekomendasi banget ini.. wisata di
                                                                                    malang
                                                                                    menyenangkan dengan driver yg
                                                                                    ramah.. sukses
                                                                                    selalu
                                                                                    Kenz Tranz. nanti kalau liburan
                                                                                    pasti saya
                                                                                    hubungi. Terima kasih</p>
                                                                            </div>
                                                                            <div class="b-reviews-2__cite"
                                                                                title="Blockquote Title">
                                                                                <span class="b-reviews-2__name">Anugrah
                                                                                    Tribeti -
                                                                                    Malang</span>
                                                                                <div class="slider-review-stars">
                                                                                    <i class="fa-solid fa-star"></i>
                                ...
                                <div class="row">
                                        ...
                                        <section class="b-post b-post-full clearfix">
                                            <div class="entry-media">
                                                <a class="js-zoom-images"
                                                    href="{{ asset('media/image/toyota-duo.JPG') }}">
                                                    <img class="img-fluid"
                                            ...
                                            <div class="entry-main">
                                                <div class="entry-meta">
                                                    ...
                                                    <span class="entry-meta__item"><a class="entry-meta__link"
                                                            href="{{ 'berita' }}"><i
                                                                class="fa-regular fa-user mr-2"></i>by
                                                            Admin</a>
                                                    </span>
                                                </div>
                                                ...
                                                <div class="entry-content">
                                                    <p>Kami menyediakan sewa mobil dinas untuk instansi yang ingin
                                                        melakukan
                                                        perjalanan dinas baik dalam kota maupun luar kota dengan
                                                        pelayanan VVIP.
                                                        Keberadaan mobil dinas bisa dikatakan sangat penting guna
                                                        meningkatkan ....
                                                    </p>
                                                </div>
                                                <div class="entry-footer"> <a
                                                        class="entry-link btn btn-default btn-sm"
                                    ...
                                    <div class="col-lg-4">
                                        <section class="b-post b-post-full clearfix">
                                            <div class="entry-media">
                                                <a class="js-zoom-images"
                                                    href="{{ asset('media/image/white-nobg.png') }}">
                                                    <img class="img-fluid"
                                            ...
                                            <div class="entry-main">
                                                <div class="entry-meta">
                                                    ...
                                                    <span class="entry-meta__item"><a class="entry-meta__link"
                                                            href="{{ 'berita' }}"><i
                                                                class="fa-regular fa-user"></i>by
                                                            Admin</a>
                                                    </span>
                                                </div>
                                                <div class="entry-header">
                                                    <h3 class="entry-title">Sewa Mobil Premium untuk Liburan Bersama
                                                        Pasangan dan
                                                        Keluarga</h3>
                                                </div>
                                                <div class="entry-content">
                                                    <p>Liburan bersama pasangan dan keluarga lebih praktis dan nyaman
                                                        menggunakan
                                                        mobil. Bepergian ke mana pun bisa lebih bebas, terlebih bila
                                                        Anda sewa mobil
                                    ...
                                    <div class="col-lg-4">
                                        <section class="b-post b-post-full clearfix">
                                            <div class="entry-media">
                                                <a class="js-zoom-images"
                                                    href="{{ asset('media/image/IMG_6623.webp') }}">
                                                    <img class="img-fluid"
                                                        src="{{ asset('media/image/IMG_6623.webp') }}"
                                                        style="width: 100%; max-height: 300px;min-height: 300px"
                                                        alt="Foto" />
                                            ...
                                            <div class="entry-main">
                                                ...
                                                <div class="entry-content">
                                                    <p>Biaya sewa mobil di Malang bervariasi tergantung pada jenis mobil
                                                        yang ingin
                                                        disewa, lama waktu sewa, dan juga fasilitas yang disediakan oleh
                                                        perusahaan
                                                        penyewaan mobil ....
                                                    </p>
                                                </div>
                                        ...
                                        <div class="b-find">
                                            <div class="b-find-content tab-content" id="findTabContent">
                                                <div class="tab-pane fade show active bg-dark" id="content-allCar">
                                                    <div class="b-find__form text-left text-white"
                                                        style="font-size: 20px">
                                                        <h3>Sewa Mobil Premium Malang</h3>
                                                        <div class="row justify-content-center">
                                                            <div class="col-8 ">
                                                                <p>Jika Anda tidak menemukan armada yang cocok , Anda
                                                                    bisa
                                                                    menghubungi admin kami. Dapatkan sewa mobil malang
                                                                    dengan
                                                                    kualitas armada yang baik, harga terjangkau dan
                                                                    pelayanan
                                                                    berkualitas</p>
                                                            </div>
                                                            <div class="col">
                                                                <a class="btn my-auto btn-primary mt-5 text-center btn-lg"
                                                                    href="https://api.whatsapp.com/send?phone=6281332033337&text=Selamat Datang di *Ken'z Tranz* Admin kami akan membalas pesan Anda secepat mungkinAnda bisa memilih beberapa layanan kami diantaranya :1. Sewa Mobil 2.. Transportasi VIP3. Perjalanan Dinas4. Acara Keluarga5. Pelayanan Tour Wisata6. Pernikahan7. Dan lain sebagainya Kami menyediakan armada terbaru yang bersih dan wangi.">
                                                                    <i class="fa-brands fa-whatsapp mr-2"></i>Pesan
                                                                    Sekarang</a>
                                                            </div>
                                                        </div>
                                                    </div>
