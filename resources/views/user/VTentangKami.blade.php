                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 mb-md-0 mb-4  text-center">
                            <div class="about-banner-text" data-aos="fade-up">
                                ...
                                <p class="text-white banner-paragraph "><strong>Ken'z Tranz</strong> adalah penyedia
                                    layanan sewa mobil
                                    (carter mobil / rental
                            ...
                            <div class="" data-aos="fade-up">
                                <div class="row justify-content-between">
                                    <div class="col-lg-7 col-md-7 col-sm-12">
                                        <h3 data-aos="zoom-out-left"><span style="color: var(--e-global-color-btn-red);">Kenz Tranz</span> - Sewa Mobil</h3>
                                        <p class="text-white text-justify"> Kenz Tranz adalah penyedia layanan sewa mobil (carter mobil / rental mobil)
                                    ...
                                    <div class="col-lg-5 col-md-5 col-sm-12 mx-auto my-auto">
                                        <div class="about-section-img">
                                            <figure class="mb-0"><img src="{{ asset('user/images/toyota-road.png ') }}"
                                                    alt="" class="img-fluid banner-img-width">
                                            </figure>
                                        </div>
                                    </div>
                                </div>
