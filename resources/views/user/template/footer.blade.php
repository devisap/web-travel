 ...
 <div class="footer-section">
    <div class="about-right-icon">
        <figure class="footer-icon"><img src="{{ asset('user/images/icon.png') }}" alt="" class="img-fluid">
        </figure>
    </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="footer-content1" data-aos="flip-left">
                        <figure>
                            <a href="{{"/"}}"><img src="{{ asset('user/images/icon.png') }}" alt="" class="img-fluid" /></a>
                        </figure>
                            ...
                            <ul class="list-unstyled contact-us-ul">
                                ...
                                <li class="list-item position-reletive addres-list icon-list1">
                                    <div class="contact-address"><a href="#"
                                            class="text-decoration-none footer-link-p ml-0"><span
                                                class="footer-additional">Addres: </span> Perumahan panorama garden blok S-45, Kec. Wagir, Kabupaten Malang, Jawa Timur 65158</a></div>
                                </li>
                            </ul>
                        </div>
                    </div>
